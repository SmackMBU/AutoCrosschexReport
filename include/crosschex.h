...
#define DEV_TYPE_FLAG_RECORD_TM         0x200000 //测温或口罩记录 (FACE7EI FACE7T FACE7M FACE7TM)
...
/*****************************************************************************
    ...
    版本4:使用字符串ID size = 28
    Data size = 338
    FingerIdx : 指纹存储号(1-10)
*****************************************************************************/

/*****************************************************************************
 * important fun
    return 
        >0  ok, return length  info
        =0, no result.
        <0  return (0 - need len)
...
/****************************************************************
 *定制Just  For   Bolid  Custom Person
 ***************************************************************/
...
/***********************************
 * 功能 : 获取设置状态切换信息  （p_dev->DevTypeFlag & 0x200000）
************************************/
...
/*****************************************************************************
  Custom For Bolid   BasiConfigInfo5
 *****************************************************************************/
